...
<link href="./resources/css/menuForm/subMenuStyle.css" rel="stylesheet"
	type="text/css">
<link href="./resources/css/admincss/admininfo.css" rel="stylesheet"
	type="text/css">
<title>SUJE</title>
</head>
<body>
	...
	<div class="adminContentsWrap">
		...
		<div class=" adminContentsBox">
			...
			<div class="account-form">
				<form id="adminForm" action="/admininfo.do" method="post">
					<div class="form-group">
						<label class="form-title" for="username">아이디</label> <input
							type="text" id="username" name="username" value="ejs" readonly="readonly">
					</div>
					<div class="form-group">
