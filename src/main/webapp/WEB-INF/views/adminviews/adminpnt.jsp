...
<link href="./resources/css/menuForm/subMenuStyle.css" rel="stylesheet"
	type="text/css">
<link href="./resources/css/admincss/adminpnt.css" rel="stylesheet"
	type="text/css">
<!DOCTYPE html>
<html>
<head>
		...
		<div class="adminSubMenuBox">
			<ul class="adminCategoryArea">
				<li class="adminFirstCategoryArea"><a href="adminmanage.jsp"
					class="adminFirstCategoryBtn">&nbsp;&nbsp;&nbsp;스토어
						입점 관리</a></li>
				<li class="storeFirstCategoryArea"><a href="adminpnt.jsp"
					class="adminFirstCategoryBtn checkedStateFirstCategory">&nbsp;&nbsp;&nbsp;스토어 벌점 관리</a></li>
				...
				<li class="adminFirstCategoryArea"><a
					href="adminstatistics.jsp" class="storeFirstCategoryBtn">&nbsp;&nbsp;&nbsp;통계</a></li>
			</ul>
		</div>
		<!-- sadminSubMenuBox -->
		<div class="adminContentsBox">
						...
						<div class="idflied">
							...
							<div class="searchBox">
								<input type="text" id="storeId" name="storeId"
									class="inputField" placeholder="아이디 검색">
								<button type="submit" id="searchButton">
									<img class="searchIcon" src="./resources/img/searchIcon.png"
										alt="검색 아이콘" width="20" height="20">
								</button>
							</div>
							<input type="text" id="searchResults" name="searchResults"
								class="searchResult" disabled>
						</div>
						<br> <label for="pntPoints" class="inputLabel">부여 벌점</label>
						<input type="number" id="pntPoints" name="pntPoints"
							class="pntPoints"> 점 <br> <label for="pntReason"
							class="inputLabel">벌점 사유</label> <br>
						<textarea id="pntReason" name="pntReason" class="pntReason"
			...
			<div class="adminSection">
				...
				<div class="pageingArea">
					<a href="#"><img src="././resources/img/pageLeftBtn.png" /></a> <a
						href="#">1</a> <a href="#">2</a> <a href="#">3</a> <a href="#"><img
						src="././resources/img/pageRightBtn.png" /></a>
				</div>
			</div>
			<!-- adminContentsBox -->
		</div>
