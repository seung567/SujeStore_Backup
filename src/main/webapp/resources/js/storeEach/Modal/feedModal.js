$(function() {
   ...
   var sliderWidth = $('.itemImage img').outerWidth(); // 이미지 너비
   var sliderLength = $('.itemImage img').length; // 전체 이미지 개수
   ...
   function slideLeft() {
      ...
      var lastSlide = $('.itemImage img:last');
      ...
      $('.itemImage').animate({ marginLeft: 0 }, 500, function() {
         ...
         $('.itemImage img:last').remove();
      });
   }
   function slideRight() {
      // 첫 번째 슬라이드를 복제하여 마지막에 추가
      var firstSlide = $('.itemImage img:first');
